...
internal class WorkAggregatorTest {
    ...
    fun testDurationAverage() {
        ...
        sut.add(Work("2022-11-07T09:00:00Z", "2022-11-07T17:00:00Z", 1, 0, 1))
        sut.add(Work("2022-11-08T09:00:00Z", "2022-11-09T11:00:00Z", 1, 0, 1))
    ...
    fun testChangesAverage() {
        val sut = WorkAggregator()
        sut.add(Work("2022-11-07T09:00:00Z", "2022-11-07T17:00:00Z", 100, 50, 2))
